...
export function previewImage(options = {}) {
    ...
    swiperDom.className = 'jump-swiper';
    ...
    swiperWrapperDom.className = 'jump-swiper-wrapper';
    ...
    for (const url of urls) {
        ...
        swiperItemDom.className = 'jump-swiper-item';
    ...
    swiperProgress.className = 'jump-swiper-progress';
