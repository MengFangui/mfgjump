...
function remove() {
    const jumpToast = document.getElementById('jump-custom-toast');
    const jumpToastMask = document.getElementById('jump-custom-toast-mask');
    jumpToast && jumpToast.parentNode.removeChild(jumpToast);
    jumpToastMask && jumpToastMask.parentNode.removeChild(jumpToastMask);
}
