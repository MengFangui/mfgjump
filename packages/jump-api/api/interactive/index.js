...
function createAnimationStyle() {
    ...
    @-webkit-keyframes jumpCustomLoadingAnimation {
        0% {
    ...
    @keyframes jumpCustomLoadingAnimation {
        0% {
            -webkit-transform: rotate3d(0, 0, 1, 0deg);
        }
        100% {
    ...
    @keyframes jumpCustomZoominAnimation {
        0% {
    ...
    @-webkit-keyframes jumpCustomZoominAnimation {
        0% {
    ...
    @keyframes jumpCustomShowMaskAnimation {
        0% {
            opacity: 0.7;
        }
        100% {
    ...
    @-webkit-keyframes jumpCustomShowMaskAnimation {
        0% {
            opacity: 0.7;
        }
        100% {
