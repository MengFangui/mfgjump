...
import {Jump, directives} from './export';
...
function initGlobalApi(Vue, vm) {
    ...
    const jumpAppInstance = vm.$root.$children[0];
    /* globals Jump */
    Vue.prototype.$api = Object.assign(Jump, {
        '$router': vm.$router,
        stopPullDownRefresh: jumpAppInstance.$refs.refresherHandler.stopPullDownRefresh,
        setNavigationBarTitle: opt => {
            ...
            jumpAppInstance.currentTitle = opt.title;
        ...
        setNavigationBarColor: opt => {
            ...
            jumpAppInstance.currentNavigationBarTextStyle = frontColor;
            jumpAppInstance.currentNavigationBarBackgroundColor = backgroundColor;
            jumpAppInstance.transitionDuration = transitionDuration
                && (transitionDuration / 1000 + 's')
                || 0;
            jumpAppInstance.transitionTimingFunc = transitionTimingFunc;
            typeof success === 'function' && success(resInfo);
            typeof complete === 'function' && complete(resInfo);
        },
        setTabBarBadge: opt => {
            ...
            jumpAppInstance.tabList[index] && (jumpAppInstance.tabList[index].badge = text);
            typeof success === 'function' && success(resInfo);
            typeof complete === 'function' && complete(resInfo);
        },
        removeTabBarBadge: opt => {
            ...
            jumpAppInstance.tabList[index] && (jumpAppInstance.tabList[index].badge = '');
            typeof success === 'function' && success(resInfo);
            typeof complete === 'function' && complete(resInfo);
        },
        showTabBarRedDot: opt => {
            ...
            jumpAppInstance.tabList[index] && (jumpAppInstance.tabList[index].showRedDot = true);
            typeof success === 'function' && success(resInfo);
            typeof complete === 'function' && complete(resInfo);
        },
        hideTabBarRedDot: opt => {
            ...
            jumpAppInstance.tabList[index] && (jumpAppInstance.tabList[index].showRedDot = false);
            typeof success === 'function' && success(resInfo);
            typeof complete === 'function' && complete(resInfo);
        },
        setTabBarStyle: opt => {
            ...
            jumpAppInstance.tabBarSelectedColor = selectedColor;
            jumpAppInstance.tabBarColor = color;
            jumpAppInstance.tabBarBackgroundColor = backgroundColor;
            jumpAppInstance.tabBarBorderStyle = borderStyle;
            typeof success === 'function' && success(resInfo);
            typeof complete === 'function' && complete(resInfo);
        },
        setTabBarItem: opt => {
            ...
            jumpAppInstance.tabList[index] && (jumpAppInstance.tabList[index].text = text);
            jumpAppInstance.tabList[index]
                && iconPath
                && (jumpAppInstance.tabList[index].iconPath = iconPath);
            jumpAppInstance.tabList[index]
                && selectedIconPath
                && (jumpAppInstance.tabList[index].selectedIconPath = selectedIconPath);
            typeof success === 'function' && success(resInfo);
            typeof complete === 'function' && complete(resInfo);
        },
        showTabBar: opt => {
            ...
            jumpAppInstance.customShowTabBar = true;
            typeof success === 'function' && success(resInfo);
            typeof complete === 'function' && complete(resInfo);
        },
        hideTabBar: opt => {
            ...
            jumpAppInstance.customShowTabBar = false;
            typeof success === 'function' && success(resInfo);
            typeof complete === 'function' && complete(resInfo);
        },
        pageScrollTo: opt => {
