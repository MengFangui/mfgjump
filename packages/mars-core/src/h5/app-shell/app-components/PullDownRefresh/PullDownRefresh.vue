<template>
    ...
    >
        <div
            ...
            :class="{
                'jump-pull-refresh-header-loading': currentStep === 3,
                'jump-pull-refresh-header-loaded': currentStep === 4
            }"
            class="jump-pull-refresh-header"
        >
            <div class="jump-pull-refresh-loading">
                <span class="jump-pull-refresh-pulling-text jump-gap-left-small">松手加载</span>
                <span class="jump-pull-refresh-loading-text jump-gap-left-small">Loading...</span>
            </div>
            <div class="jump-pull-refresh-loaded">
                <span class="jump-pull-refresh-loaded-text jump-gap-left-middle">
                    刷新完毕
                </span>
            </div>
        </div>
        <div class="jump-pull-refresh-content">
            <slot/>
        </div>
    </div>
</template>
...
.jump-pull-refresh-wrap {
    font-size: 15px;
}
.jump-pull-refresh-header {
    height: 0;
    text-align: center;
    overflow: hidden;
...
.jump-pull-refresh-loading-icon {
    display: none;
    margin: 20px 0;
    width: 18px;
    height: 18px;
...
.jump-pull-refresh-loading-text {
    display: none;
    font-size: 12px;
    line-height: 1;
    color: #c6c6c6;
...
.jump-pull-refresh-loaded {
    display: none;
    height: 28px;
    color: #000;

    .jump-pull-refresh-loaded-text {
...
.jump-pull-refresh-header-loading {
    .jump-pull-refresh-pulling-text {
        display: none;
    }
    .jump-pull-refresh-loading-text {
        display: inline-block;
...
.jump-pull-refresh-header-loaded {
    .jump-pull-refresh-loading {
        display: none;
    }
    .jump-pull-refresh-loaded {
