<template>
    <div>
        ...
        <div id="jump-background" ref="jumpBackground"></div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        ...
        this.$refs.jumpBackground.style.backgroundColor = this.currentBackgroundColor || '#fff';
    ...
    methods: {
        afterEnter() {
            ...
            this.$refs.currentRouter.$emit('jumpTransitionEnterEnd');
            this.$refs.jumpBackground.style.backgroundColor = this.currentBackgroundColor || '#fff';
            this.hasNavigationBar = this.currentNavigationStyle === 'default';
            this.$nextTick(() => {
                if (this.isBack) {
