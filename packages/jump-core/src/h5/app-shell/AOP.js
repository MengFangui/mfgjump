...
const AOP_MAP = {
    App: {
        onLaunch: 'jumpAppAfterCreated',
        onShow: 'jumpAppAfterMounted',
        onHide: 'jumpAppAfterDestroyed'
    },
    Page: {
        onLoad: 'jumpPageAfterCreated',
        onReady: 'jumpPageAfterMounted',
        onUnload: 'jumpPageAfterDestroyed',
        onShow: 'jumpPageAfterActivated',
        onHide: 'jumpPageAfterDeactivated'
    }
};
const PageAOPEvents = {
    onLoad: [],
